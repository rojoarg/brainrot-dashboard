    ...
    <div className="d-flex flex-col gap-4">
      ...
      <div>
        ...
        <div className="grid-strategies stagger-in">
          {Object.entries(STRATEGIES).map(([id, s]) => {
            ...
            return (
              <div key={id} onClick={() => setActiveStrategy(id)} role="button" tabIndex={0} onKeyDown={e => e.key === 'Enter' && setActiveStrategy(id)}
                ...
                <div className="d-flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-muted" style={{ lineHeight: 1.3 }}>{s.desc}</div>
                  </div>
                </div>
              </div>
            );
      ...
      <div className="filter-panel">
        <div className="filter-panel-header" onClick={() => setShowFilters(!showFilters)}>
          ...
          <span className="text-md text-muted" style={{ transition: 'transform 0.2s', transform: showFilters ? 'rotate(180deg)' : 'none' }}>{'\u25BC'}</span>
        </div>
        {showFilters && (
          <div className="filter-panel-body flex-col gap-3">
            <div className="grid-filters">
              ...
              <div>
                ...
                <select className="select" value={rarity} onChange={e => setRarity(e.target.value)} style={{ width: '100%' }}>
            ...
            <div>
              ...
              <div className="d-flex gap-2 mb-2">
                <input className="input" placeholder="Add name..." value={blInput} onChange={e => setBlInput(e.target.value)} style={{ maxWidth: 200 }}
          ...
          <div className="preview-body">
            <div className="table-wrap">
              <table className="dash-table" role="table">
                <thead><tr role="row">
                  <th style={{ width: 30 }} role="columnheader">#</th>
        ...
        <div className="config-success">
          <div className="d-flex justify-between items-center flex-wrap gap-2">
            ...
            <div className="d-flex gap-2">
              ...
              <button type="button" className="btn-cta" onClick={generateAndDownload} style={{ padding: '6px 16px' }}>Re-Generate</button>
            </div>
          </div>
        </div>
      )}
